...
export default function Edit({ asset }: { asset: Asset }) {
    ...
    return (
        <>
            <h1 className="mb-6 text-2xl font-bold text-gray-800">Edit Aset</h1>
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setData('user_assigned', e.target.value)
                                }
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setData('inventory_status', e.target.value)
                                }
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            >
...
Edit.layout = (page: React.ReactElement) => (
    <AppLayout title="Edit Aset" children={page} />
);
