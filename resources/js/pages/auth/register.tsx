    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            ...
            <div className="w-full max-w-sm p-8 space-y-6 bg-white rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold text-center text-gray-700">Buat Akun Baru</h3>
                <Form
                        ...
                        <>
                            <div className="grid gap-4">
                                <div className="grid gap-2">
                                    ...
                                    <Input id="name" name="name" required autoFocus autoComplete="name" placeholder="Nama Lengkap Anda" />
                                    <InputError message={errors.name} />
                                </div>
                                <div className="grid gap-2">
                                    <Label htmlFor="email">Alamat Email</Label>
                                    <Input id="email" type="email" name="email" required autoComplete="username" placeholder="anda@perusahaan.com" />
                            ...
                            <Button type="submit" className="mt-2 w-full" disabled={processing} style={{ backgroundColor: '#4f46e5' }}>
                                {processing && <Spinner />}
                                Daftar
                            </Button>
