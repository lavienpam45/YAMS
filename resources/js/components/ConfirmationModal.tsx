...
interface ConfirmationModalProps {
    show: boolean; // Menentukan apakah modal tampil atau tidak
    onClose: () => void; // Fungsi yang dijalankan saat modal ditutup (misal, klik batal)
    onConfirm: () => void; // Fungsi yang dijalankan saat tombol "Hapus" diklik
    title: string; // Judul modal
    message: string; // Pesan di dalam modal
}
